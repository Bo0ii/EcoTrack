  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<DevicesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DevicesRecord> detailedDeviceInfoDevicesRecordList =
            snapshot.data!;
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'mj2t7qec' /* Current Cost (0.2% error) */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'foe5uilr' /* Predicted Tomorrow's Cost */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'ewrwwbmr' /* Projected Monthly Cost */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
