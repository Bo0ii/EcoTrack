...
import 'oldmainpage_model.dart';
export 'oldmainpage_model.dart';

class OldmainpageWidget extends StatefulWidget {
  const OldmainpageWidget({
    super.key,
    String? email,
  ...
  static String routeName = 'OLDMAINPAGE';
  static String routePath = '/OLDMAINPAGE';

  @override
  State<OldmainpageWidget> createState() => _OldmainpageWidgetState();
}

class _OldmainpageWidgetState extends State<OldmainpageWidget> {
  late OldmainpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OldmainpageModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: Color(0xFFCFFEFE),
            body: Center(
              child: SizedBox(
                width: 40.0,
                height: 40.0,
        ...
        List<UsersRecord> oldmainpageUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final oldmainpageUsersRecord = oldmainpageUsersRecordList.isNotEmpty
            ? oldmainpageUsersRecordList.first
            : null;
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        final containerGetSensorDataResponse =
                                                            snapshot.data!;
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: InkWell(
                                                                                ...
                                                                                onTap: () async {
                                                                                  ...
                                                                                  safeSetState(() {});
                                                                                  if (listViewDevicesRecord.userControl.contains(widget.email) == true) {
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '5oodtx7e' /* Use natural light when possibl... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
