...
class HomeNewCopyWidget extends StatefulWidget {
  ...
  static String routeName = 'HomeNewCopy';
  static String routePath = '/homeNewCopy';

  @override
  State<HomeNewCopyWidget> createState() => _HomeNewCopyWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> homeNewCopyUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homeNewCopyUsersRecord = homeNewCopyUsersRecordList.isNotEmpty
            ? homeNewCopyUsersRecordList.first
            : null;
                                    ...
                                    children: [
                                      StreamBuilder<List<DevicesRecord>>(
                                        stream: queryDevicesRecord(
                                          parent:
                                              homeNewCopyUsersRecord?.reference,
                                        ),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        color: valueOrDefault<
                                                                            Color>(
                                                                          functions.getSensorState(FFAppState().sensorData.toList(), listViewDevicesRecord.deviceId, 'current') == '0.000'
                                                                              ? Color(0xFF979797)
                                                                              : Color(0xFF00BEC8),
                                                                          Color(
                                                                              0xFF737373),
