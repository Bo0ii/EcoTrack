  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: Color(0xFFADCBCB),
            body: Center(
              child: SizedBox(
                width: 40.0,
                height: 40.0,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '1hzza2kf' /* Notification Settings */,
                                                    ),
