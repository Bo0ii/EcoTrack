                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '13n4kxb9' /* Create your user account below... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleMedium
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'o3vi3tty' /* Enter your Admin's Household I... */,
                                              ),
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '1iuuh0qt' /* Already have an account? */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
