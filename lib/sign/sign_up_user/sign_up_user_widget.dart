                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xFFC6FEFF), Color(0xFFFBFBFB)],
                        stops: [0.0, 0.3],
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'jvf5tw8d' /* Create your user account below... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .titleMedium
                                            .override(
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'opb17kbn' /* Enter your Admin's Household I... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      AnimatedOpacity(
                                        opacity: _model.passwordTextController
                                                        .text !=
                                                    ''
                                            ? 1.0
                                            : 0.0,
                                  ...
                                  InkWell(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'byzno26g' /* Already have an account? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
