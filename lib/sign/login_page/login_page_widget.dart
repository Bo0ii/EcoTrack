                                              ...
                                              children: [
                                                Opacity(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'v9n5z6y0' /* Login to access your account b... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .titleMedium
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'ua4niyl4' /* Don't have an account? */,
                                                          ),
