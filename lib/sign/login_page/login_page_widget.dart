                                          ...
                                          children: [
                                            Opacity(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'jw9yi5x7' /* Login to access your account b... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .titleMedium
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '9eujq5j1' /* Don't have an account? */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
