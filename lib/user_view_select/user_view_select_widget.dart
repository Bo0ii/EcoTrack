...
import 'user_view_select_model.dart';
export 'user_view_select_model.dart';

class UserViewSelectWidget extends StatefulWidget {
  const UserViewSelectWidget({super.key});

  static String routeName = 'UserViewSelect';
  static String routePath = '/userViewSelect';

  @override
  State<UserViewSelectWidget> createState() => _UserViewSelectWidgetState();
}

class _UserViewSelectWidgetState extends State<UserViewSelectWidget> {
  late UserViewSelectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserViewSelectModel());
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                FFLocalizations.of(context).getText(
                  'f6u0ysgu' /* Invite your friends to join yo... */,
                ),
