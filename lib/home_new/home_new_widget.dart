  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> homeNewUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homeNewUsersRecord = homeNewUsersRecordList.isNotEmpty
            ? homeNewUsersRecordList.first
            : null;
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: Icon(
                                                                                    ...
                                                                                    color: valueOrDefault<Color>(
                                                                                      FFAppState().currentData != '0' ? FlutterFlowTheme.of(context).primary : Color(0xFF979797),
                                                                                      Color(0xFF737373),
                                                                                    ),
                                                                                    size: 25.0,
                                                                                  ),
