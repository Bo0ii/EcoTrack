...
class _S3WidgetState extends State<S3Widget> {
  late S3Model _model;
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'avegjq8m' /* Select the rooms in your house... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
