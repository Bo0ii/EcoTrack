...
import 's3_copy_model.dart';
export 's3_copy_model.dart';
...
/// rooms.
class S3CopyWidget extends StatefulWidget {
  const S3CopyWidget({super.key});

  static String routeName = 'S3Copy';
  static String routePath = '/s3Copy';

  @override
  State<S3CopyWidget> createState() => _S3CopyWidgetState();
}

class _S3CopyWidgetState extends State<S3CopyWidget>
    with TickerProviderStateMixin {
  late S3CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S3CopyModel());
                            ...
                            Expanded(
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'tdma5ubg' /* Select the rooms in your house... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
